...
func TestCountLines (t *testing.T) {
	...
	tests := []test{
		{input: "/home/Chamundsen/minyr/kjevik-temp-celsius-20220318-20230318.csv", want: 16756},
		{input: "/home/Chamundsen/minyr/kjevik-temp-fahr-20220318-20230318.csv", want: 16756},
	}
...
func TestAverage (t *testing.T) {
	type test struct {
	 ...
	 tests := []test{
                {input: "/home/Chamundsen/minyr/kjevik-temp-celsius-20220318-20230318.csv", want: 8.56},
                {input: "/home/Chamundsen/minyr/kjevik-temp-fahr-20220318-20230318.csv", want: 47.4},
        }
