...
import (
	...
	yr "github.com/Chamundsen/minyr/yr"
)
	...
	*/
	for scanner.Scan() {
		...
		if input == "q" || input == "exit" {
			...
			fmt.Println("Konverterer alle målingene gitt i grader Celsius til grader Farhrenheit")
			//open file
			...
			fmt.Println("celsius eller fahrenheit")
